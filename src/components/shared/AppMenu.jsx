      ...
      >
        ...
        <div className="flex-1 px-3 py-2 space-y-4">
          ...
          {!isLite && !isSalesPartner && (
            <div>
              <p className="px-3 mb-1 text-[10px] font-bold text-slate-600 uppercase tracking-wider">장외거래</p>
              <button onClick={() => setOtcExpanded(v => !v)} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-300 hover:text-white hover:bg-[#151c2e] transition-all group">
                ...
                <span className="text-sm font-medium flex-1 text-left">장외거래 개요</span>
              ...
              {otcExpanded && (
                <div className="ml-4 mt-0.5 space-y-0.5 pl-3 border-l border-[rgba(148,163,184,0.08)]">
                  {[
                    { label: '장외거래 개요',    page: 'OTCOverview',         icon: Layers },
                    { label: '개인 간 거래',      page: 'P2PRWAExchange',      icon: ArrowDownUp },
                    { label: '부동산 장외거래',   page: 'RealEstateP2P',       icon: Building2 },
                    { label: '금 실물 거래',      page: 'GoldP2PMarket',       icon: DollarSign },
                    { label: '대량 거래 데스크',  page: 'OTCBlockTrade',       icon: Package },
                    { label: '실물 인도 신청',    page: 'MyDeliveryRequests',  icon: Truck },
                    { label: '내 거래 내역',      page: 'MyP2POrders',         icon: Archive },
                    { label: '내 등록 자산',      page: 'MyOTCListings',       icon: FileText },
                    { label: '분쟁 / 지원',       page: 'OTCSupportDispute',   icon: HelpCircle },
