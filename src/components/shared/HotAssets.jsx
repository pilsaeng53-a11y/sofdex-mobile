...
function HotAssetItem({ asset, index, expanded, setExpanded }) {
  ...
  return (
    <div>
      ...
      >
        <CoinIcon symbol={asset.symbol} size={36} debugLabel="HotAssets" />
        ...
        <div className="text-right flex-shrink-0">
         <p className="text-sm font-bold text-white">
           {displayPrice && displayPrice > 0 ? formatPriceRealtime(displayPrice, displayCurrency, exchangeRates) : '$0.00'}
         </p>
        ...
        <div className="px-4 pb-3 mx-4 mb-2 bg-[#0a0e1a] rounded-xl border border-[rgba(148,163,184,0.06)]">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-[rgba(148,163,184,0.06)]">
            <span className="text-[10px] text-slate-500">
              ...
              {displayPrice && displayPrice > 0 && <span className="text-slate-300 ml-1">{formatPriceRealtime(displayPrice, displayCurrency, exchangeRates)}</span>}
            </span>
