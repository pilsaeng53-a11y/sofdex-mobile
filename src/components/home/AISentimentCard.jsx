           ...
           <div className="relative z-10">
             <div className="flex items-center justify-between mb-3">
               <div className="flex items-center gap-2">
                 ...
                 <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wider">{t('ai_marketSentiment')}</span>
               </div>
               <ChevronRight className="w-4 h-4 text-slate-600" />
             </div>
             <div className="flex items-center justify-between mb-2">
               <div>
                 <p className="text-xl font-black text-emerald-400">{t('sentiment_bullish')}</p>
                 <p className="text-[10px] text-slate-500 mt-0.5">{t('ai_highConfidence')} · Score 74/100</p>
               </div>
               <div className="text-right">
                 <div className="flex gap-1.5">
                   <span className="px-2 py-1 rounded-lg bg-emerald-400/10 text-emerald-400 text-[9px] font-bold border border-emerald-400/20">AI {t('ai_tab_signals')}: 6 {t('sentiment_bullish')}</span>
                 </div>
               </div>
             </div>
