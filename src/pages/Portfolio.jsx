        ...
        <div className="relative overflow-hidden glass-card rounded-2xl p-5 glow-border">
          ...
          <div className="relative z-10">
            <p className="text-[11px] text-slate-500 font-medium mb-1">
              {isConnected ? t('portfolio_totalBalance') : 'Connect wallet to see holdings'}
            </p>
            <h2 className="text-3xl font-bold text-white mb-1">
              {loading ? '...' : showBalance ? totalBalance : '••••••'}
            </h2>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-slate-500">{isConnected ? t('portfolio_24hPnl') : 'Solana wallet'}</span>
            </div>
          </div>
        </div>
      </div>
