      ...
      <div className="px-4 py-8 max-w-lg mx-auto">
        <div className="glass-card rounded-2xl p-6 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">There was an issue fetching your wallet data. Please try again.</p>
            <button onClick={() => window.location.reload()} className="mt-3 text-xs text-[#00d4aa] hover:text-[#00d4aa]/80 font-semibold">
              Retry
            </button>
          </div>
        </div>
